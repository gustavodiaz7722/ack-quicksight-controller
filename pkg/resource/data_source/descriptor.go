...
const (
	FinalizerString = "finalizers.quicksight.services.k8s.aws/DataSource"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("datasources")
